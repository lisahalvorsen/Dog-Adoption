...
function drawMenu() {
    ...
    html += /*HTML*/ `
    <div id="menu">
        <img src="/Images/olalogo.png" alt="Logo for Olas Hunderedning" id="ola-logo" onclick="changeView('mainPage')">
...
function homePageView() {
    app.innerHTML = /*HTML*/ ` 
    ${drawMenu()}
    <img src="/Images/toller.png" alt="A toller dog" id="toller">
...
function aboutUsView() {
    ...
    <img src="/Images/finnishlapphund.png" class="familydog-picture" alt="Hero, a Finnish lapphund">
        <img src="/Images/toller2.png" class="familydog-picture" alt="Kompis, a toller">
        <img src="/Images/bordercollie.png" class="familydog-picture" alt="Maya, a Border collie">
    </div>
    `;
}
...
function makePaw(amount) {
    let html = '';
    html += `<img id="paw-icon" src="Images/pawicon.png">`.repeat(amount);
    return html;
}
